...
<div class="main">
    ...
    <div class="news1">
        <div class="news_left">
            ...
            <ul>
                <c:forEach items="${schoolNewsList}" var="school">
                    <li>
                        <a href="/news-content?id=${school.id}">
                            <p>${school.title}</p>
                            <span><fmt:formatDate value="${school.anow}" pattern="yyyy-MM-dd"/></span>
                        </a>
                    </li>
                </c:forEach>
            </ul>
        ...
        <div class="news_left">
            ...
            <ul>
                <c:forEach items="${industryNewsList}" var="industry">
                    <li>
                        <a href="/news-content?id=${industry.id}">
                            <p>${industry.title}</p>
                            <span><fmt:formatDate value="${industry.anow}" pattern="yyyy-MM-dd"/></span>
                        </a>
                    </li>
                </c:forEach>
            </ul>
